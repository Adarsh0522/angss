...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="py-32 bg-[#011812] text-white relative overflow-hidden"
    >
      ...
      <div className="container-wide mx-auto grid lg:grid-cols-2 gap-20 lg:gap-24 relative z-10">
        {/* Left: Intro */}
        <motion.div
        ...
        >
          ...
          <p className="text-lg text-stone-300 leading-relaxed mb-12 max-w-lg">
            आपल्याला स्वयंसेवक म्हणून सहभागी व्हायचे असेल, योगदान द्यायचे असेल,
            सहकार्य करायचे असेल किंवा आमच्या उपक्रमांबद्दल अधिक जाणून घ्यायचे
            असेल, तर आम्हाला नक्की संपर्क करा.
          </p>

          {/* Decorative line */}
          <div className="w-24 h-1 bg-gradient-to-r from-gold to-amber-400 rounded-full" />
        </motion.div>
        ...
        >
          <div className="space-y-10">
            ...
            <div className="flex items-start gap-6 group">
              ...
              <div>
                <p className="font-bold text-xl mb-2 text-white group-hover:text-gold transition-colors">
                  ठिकाण
                </p>
              ...
              <div className="flex gap-4">
                {[Instagram, Twitter, Facebook, Linkedin].map((Icon, i) => (
                  <a
                    key={i}
                    href="#"
                    className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-gold hover:border-gold hover:-translate-y-1 transition-all duration-300 shadow-lg"
                  >
                    <Icon size={21} />
                  </a>
                ))}
        ...
        >
          ...
          <div className="w-full h-[250px] bg-forest rounded-3xl overflow-hidden border border-white/10 relative group shadow-2xl">
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
              <span className="px-6 py-3 bg-black/60 backdrop-blur-md rounded-xl text-sm font-bold tracking-widest text-stone-300 border border-white/10">
