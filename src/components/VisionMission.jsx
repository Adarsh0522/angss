...
const MissionCard = ({ title, icon: Icon, desc, delay }) => (
  ...
  >
    ...
    <h3 className="font-bold text-2xl text-white mb-4 group-hover:text-gold transition-colors">
      {title}
    </h3>
    <p className="text-sm text-stone-300 leading-relaxed group-hover:text-white transition-colors">
      {desc}
    </p>
  </motion.div>
);
...
const VisionMission = () => {
  return (
    <section
      id="vision"
      className="py-32 relative overflow-hidden bg-[#011812]"
    >
      ...
      <div
        className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-gold/10 rounded-full blur-[120px] translate-y-1/2 pointer-events-none animate-blob"
      ...
      <div className="container-wide mx-auto space-y-24 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 text-center lg:text-left">
            <span className="text-gold font-bold uppercase tracking-widest text-sm mb-4 block animate-pulse">
              व्हिजन २०३०
            </span>
            <h2 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight drop-shadow-md">
              सशक्त गावांची उभारणी, <br />{" "}
              ...
              <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
                ...
                <div>
                  <p className="text-xl md:text-2xl text-stone-200 leading-relaxed font-medium">
                    आम्ही अशा कोकणाची कल्पना करतो जिथे प्रत्येक मुलाला शिक्षणाची
                    संधी मिळेल, प्रत्येक शेतकऱ्याला शाश्वत संधी मिळतील, प्रत्येक
                    कुटुंबाला आरोग्यसेवा उपलब्ध होईल आणि प्रत्येक गाव सन्मान,
                    स्वावलंबन आणि आशेने विकसित होईल.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <MissionCard
              title="शिक्षण"
              desc="शिष्यवृत्ती, मार्गदर्शन आणि शिक्षणाच्या संधींच्या माध्यमातून गरजू ग्रामीण विद्यार्थ्यांना सहकार्य करणे."
              icon={BookOpen}
              delay={0.1}
            />
            <MissionCard
              title="शेती"
              desc="शाश्वत शेतीला प्रोत्साहन देणे आणि नाविन्यपूर्ण ग्रामीण उद्योजकतेला चालना देणे."
              icon={Leaf}
              delay={0.2}
            />
            <MissionCard
              title="जलसंधारण"
              desc="गावाच्या दीर्घकालीन शाश्वततेसाठी समुदायाच्या सहभागातून जलसंधारण प्रकल्प विकसित करणे."
              icon={Droplet}
              delay={0.3}
            />
            <MissionCard
              title="ग्रामविकास"
              desc="आरोग्य, जनजागृती, रोजगार आणि सामाजिक उपक्रमांच्या माध्यमातून गावांना अधिक सक्षम बनवणे."
              icon={Handshake}
              delay={0.4}
            />
          </div>
