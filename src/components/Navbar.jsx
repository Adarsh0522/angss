                ...
                >
                    ...
                    <a href="#" className="flex items-center gap-3 group">
                        <div className="w-10 h-10 overflow-hidden rounded-full border border-stone-200 group-hover:border-gold transition-colors bg-white flex-shrink-0">
                            <img src={logo} alt="ANGSS Logo" className="w-full h-full object-cover" />
                        </div>
                        <span className={cn("font-bold text-lg tracking-tight transition-colors flex items-center", scrolled ? "text-[#d97706]" : "text-white group-hover:text-[#d97706]")}>
                                ...
                                <li key={link.name}>
                                    <a
                                        ...
                                        className={cn(
                                            ...
                                            scrolled ? "text-stone-700 hover:text-gold" : "text-stone-200 hover:text-white"
                                        )}
                                    >
                                        {link.name}
                                    </a>
                    ...
                    {/* Mobile Menu Button */}
                    <button
                        className={cn("md:hidden p-2 rounded-full transition-colors", scrolled ? "text-forest hover:bg-stone-100" : "text-white hover:bg-white/20")}
                    ...
                    >
                        <div className="flex items-center justify-between mb-12">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-forest to-forest-light text-white flex items-center justify-center font-bold shadow-lg">अ</div>
                                <span className="font-bold text-xl text-forest">अमरज्योत नवतरुण ग्रामविकास सेवा संस्था</span>
                            </div>
                            <button
