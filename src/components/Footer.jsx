...
const Footer = () => {
    return (
        <footer className="bg-[#011812] pt-24 pb-12 border-t border-white/5 relative overflow-hidden">
            ...
            <div className="container-wide mx-auto relative z-10">
                <div className="flex flex-col lg:flex-row justify-between items-start gap-16 mb-20">
                    ...
                    <div className="max-w-md">
                        ...
                        <h3 className="text-3xl font-bold text-white mb-8 leading-tight">
                            चला, एकत्र येऊन सक्षम गावे आणि <span className="text-gold">उज्ज्वल भविष्य घडवूया.</span>
                        </h3>
                        <div className="flex gap-4">
                            {[Instagram, Facebook, Twitter, Linkedin].map((Icon, i) => (
                                <a key={i} href="#" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-gold hover:border-gold hover:-translate-y-1 transition-all duration-300 shadow-lg">
                                    <Icon size={20} />
                                </a>
                            ))}
                        </div>
                    ...
                    <div className="flex gap-16 md:gap-24 flex-wrap">
                        <div>
                            <h4 className="font-bold text-lg text-white mb-8 tracking-wider">एक्सप्लोर</h4>
                            <ul className="space-y-5">
                                {['आमच्याबद्दल', 'ध्येय', 'आमचे उपक्रम', 'गॅलरी'].map(item => (
                                    <li key={item}>
                                        <a href="#" className="text-stone-400 hover:text-gold transition-colors block w-fit text-lg">
                                            {item}
                                        </a>
                                    </li>
                                ))}
                        ...
                        <div>
                            <h4 className="font-bold text-lg text-white mb-8 tracking-wider">कायदेशीर</h4>
                            <ul className="space-y-5">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 text-stone-500">
                    <p className="mb-4 md:mb-0">© 2026 अमरज्योत ग्रामविकास ट्रस्ट. सर्व हक्क राखीव.</p>
